...
$(document).ready(function(){function o(o){o&&120<this.scrollTop()?i.css("display","block"):120<this.scrollTop()?i.fadeIn(500):i.fadeOut(500)}document.createElement("picture"),$("body").removeClass("no-js");var i=$(".arrow"),n=$("html, body"),t=$(window);o.call(t,!0),t.on("scroll",function(){o.call($(this)),$("body").css("background-position","right "+($(this).scrollTop()/2-465)+"px top "+($(this).scrollTop()/2-333)+"px, left "+($(this).scrollTop()/2-465)+"px bottom "+($(this).scrollTop()/2-333)+"px")}),i.on("click",function(){n.animate({scrollTop:0},400)}),$(".navigation__toggle").on("click",function(){$(".navigation__list").toggleClass("active")});var c=$(".price__header");c.on("click",function(){$(".price__block:visible").not($(this).next()).slideUp(300),$(this).next().slideToggle(300,function(){$(this).prev().children(".price__arrow, .price__arrow--green").toggleClass("price__arrow--rotate")})}),c.hover(function(){$(this).children(".price__arrow").animate({opacity:0},300),$(this).children(".price__arrow--green").animate({opacity:1},300)},function(){$(this).children(".price__arrow").animate({opacity:1},300),$(this).children(".price__arrow--green").animate({opacity:0},300)}),$(".navigation__link").hover(function(){$(this).animate({color:"#0092c2"},300)},function(){$(this).animate({color:"#00b7f4"},300)}),$(".navigation__button").hover(function(){$(this).animate({"background-color":"#008bb9"},300)},function(){$(this).animate({"background-color":"#00b3ef"},300)}),$(".help").hover(function(){$(this).animate({"background-color":"#00b7f4",color:"#ffffff"},300)},function(){$(this).animate({"background-color":"#ffffff",color:"#5b5b5b"},300)}),$(".phone").hover(function(){$(this).animate({color:"#00aee8"},300)},function(){$(this).animate({color:"#1f1f1f"},300)}),$(".social").hover(function(){$(this).animate({"background-color":"rgba(255, 255, 255, 0.5)"},300)},function(){$(this).animate({"background-color":"transparent"},300)})});